...
var ConsentCheckboxField = React9.forwardRef(
  ({ consentText, controllerText, moreHref = "#", ...props }, ref) => /* @__PURE__ */ jsxs5("label", { className: "flex gap-3 text-xs text-muted-foreground", children: [
    /* @__PURE__ */ jsx10(Checkbox, { ref, ...props }),
    /* @__PURE__ */ jsxs5("span", { children: [
      consentText,
      /* @__PURE__ */ jsxs5("span", { className: "mt-2 block text-[11px]", children: [
        controllerText,
        " ",
        /* @__PURE__ */ jsx10(Link, { variant: "underline", href: moreHref, children: "More" })
      ] })
    ] })
  ] })
);
...
function StatBlock({ className, eyebrow = "UP TO", value, label, ...props }) {
  return /* @__PURE__ */ jsxs6("div", { className: cn("bg-transparent pr-6", className), ...props, children: [
    /* @__PURE__ */ jsx11("div", { className: "text-[10px] font-semibold uppercase tracking-wider text-muted-foreground", children: eyebrow }),
    /* @__PURE__ */ jsx11("div", { className: "mt-3 font-display text-[56px] leading-none md:text-[72px]", children: value }),
    /* @__PURE__ */ jsx11("div", { className: "mt-6 text-sm text-muted-foreground", children: label })
  ] });
}
...
function IconFeatureItem({
  ...
  return /* @__PURE__ */ jsxs7("li", { className: cn("flex gap-4", className), ...props, children: [
    /* @__PURE__ */ jsx12(Icon, { className: cn("mt-1 h-5 w-5 shrink-0", iconClassName) }),
    /* @__PURE__ */ jsxs7("div", { children: [
      /* @__PURE__ */ jsx12(Heading, { className: "font-display text-h6", children: title }),
      /* @__PURE__ */ jsx12("p", { className: "mt-1 text-sm text-muted-foreground", children: description })
    ] })
  ] });
}
...
function BulletItem({ className, children, ...props }) {
  return /* @__PURE__ */ jsxs8("li", { className: cn("flex gap-3", className), ...props, children: [
    /* @__PURE__ */ jsx13("span", { className: "mt-2 inline-block h-1 w-1 shrink-0 rounded-full bg-muted-foreground" }),
    children
  ] });
}
...
function IconCard({ className, icon: Icon, title, bullets, color, ...props }) {
  return /* @__PURE__ */ jsxs9("div", { className: cn("rounded-3xl bg-card p-8 shadow-sm", className), ...props, children: [
    /* @__PURE__ */ jsxs9("div", { className: "flex items-start justify-between gap-4", children: [
      /* @__PURE__ */ jsx14("h3", { className: "font-display text-h4", children: title }),
      /* @__PURE__ */ jsx14(
        "div",
        {
          className: "grid h-12 w-12 shrink-0 place-items-center rounded-xl",
          style: { background: `linear-gradient(135deg, ${color}, color-mix(in oklab, ${color} 40%, white))` },
          children: /* @__PURE__ */ jsx14(Icon, { className: "h-5 w-5 text-foreground" })
        }
      )
    ] }),
    /* @__PURE__ */ jsx14("ul", { className: "mt-8 space-y-2 text-muted-foreground", children: bullets.map((bullet) => /* @__PURE__ */ jsx14(BulletItem, { children: bullet }, bullet)) })
  ] });
}
...
function StepCard({ className, index, title, body, ...props }) {
  return /* @__PURE__ */ jsxs10("li", { className: cn("p-8", className), ...props, children: [
...
function IndustryCard({
  ...
  const imageBlock = /* @__PURE__ */ jsx18(
    "div",
    {
      className: cn(
        "bg-cover bg-center",
  ...
  const content = /* @__PURE__ */ jsxs11("div", { className: cn(layout === "stacked" ? "flex flex-col justify-between p-10 md:p-12" : "p-8"), children: [
    /* @__PURE__ */ jsx18(
      "h3",
      {
    ...
    /* @__PURE__ */ jsxs11("div", { className: layout === "grid" ? "mt-4" : void 0, children: [
      /* @__PURE__ */ jsx18("p", { className: cn("max-w-md text-sm leading-relaxed text-foreground/75", layout === "stacked" && "mt-8"), children: description }),
      /* @__PURE__ */ jsx18(
        Button,
        {
          type: "button",
  ...
  return /* @__PURE__ */ jsx18(
    "article",
    {
      ...
      ...props,
      children: layout === "stacked" ? /* @__PURE__ */ jsxs11(Fragment, { children: [
        content,
        imageBlock
...
function OverlapCard({
  ...
  return /* @__PURE__ */ jsxs12(
    "article",
    {
      ...
      ...props,
      children: [
        /* @__PURE__ */ jsxs12("div", { className: "flex flex-col justify-between p-10 md:p-12", children: [
          /* @__PURE__ */ jsx19("h3", { className: "font-display text-h3 whitespace-pre-line", children: title }),
          /* @__PURE__ */ jsxs12("div", { className: "mt-8", children: [
            /* @__PURE__ */ jsx19("p", { className: "max-w-md text-sm leading-relaxed text-foreground/75", children: description }),
            /* @__PURE__ */ jsxs12("div", { className: "mt-8 flex flex-wrap gap-3", children: [
              /* @__PURE__ */ jsx19(Button, { type: "button", variant: "solid", size: "xs", onClick: primaryCta.onClick, children: primaryCta.label }),
              /* @__PURE__ */ jsx19(
                Button,
                {
                  type: "button",
...
var AccordionItem = React11.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx20(AccordionPrimitive.Item, { ref, className: cn("border-b", className), ...props }));
AccordionItem.displayName = "AccordionItem";
var AccordionTrigger = React11.forwardRef(({ className, children, ...props }, ref) => /* @__PURE__ */ jsx20(AccordionPrimitive.Header, { className: "flex", children: /* @__PURE__ */ jsxs13(
  AccordionPrimitive.Trigger,
  {
    ...
    children: [
      children,
      /* @__PURE__ */ jsx20(ChevronDown2, { className: "h-4 w-4 shrink-0 text-muted-foreground transition-transform duration-200" })
    ]
  }
) }));
AccordionTrigger.displayName = AccordionPrimitive.Trigger.displayName;
var AccordionContent = React11.forwardRef(({ className, children, ...props }, ref) => /* @__PURE__ */ jsx20(
...
function FaqItem({ value, question, answer }) {
  return /* @__PURE__ */ jsxs14(AccordionItem, { value, className: "rounded-2xl border-0 bg-card px-6 py-1 md:px-8", children: [
    /* @__PURE__ */ jsx21(AccordionTrigger, { className: "py-6 text-left text-lg font-semibold hover:no-underline md:text-xl [&>svg]:size-5", children: question }),
    /* @__PURE__ */ jsx21(AccordionContent, { className: "pb-8 pt-2 text-base text-muted-foreground md:text-[17px]", children: answer })
  ] });
}
...
function PartnerCountBadge({ className, count, label, ...props }) {
  return /* @__PURE__ */ jsxs15(
    "div",
    {
      ...
      ...props,
      children: [
        /* @__PURE__ */ jsx22("span", { className: "text-sm font-semibold text-foreground", children: count }),
        /* @__PURE__ */ jsx22("span", { className: "text-xs", children: label })
      ]
    }
  );
}
