...
function HeroVideoSplit({ eyebrow, title, subtitle, ctaLabel, ctaHref, videoSrc }) {
  return /* @__PURE__ */ jsx7("section", { className: "mx-auto max-w-[1280px] px-6 pt-16 md:pt-24", children: /* @__PURE__ */ jsxs3("div", { className: "grid items-center gap-10 md:grid-cols-2", children: [
    /* @__PURE__ */ jsxs3("div", { children: [
      eyebrow && /* @__PURE__ */ jsx7("div", { className: "mb-6", children: /* @__PURE__ */ jsx7(Badge, { variant: "eyebrow", children: eyebrow }) }),
      /* @__PURE__ */ jsx7("h1", { className: "font-display text-[48px] leading-[1.05] tracking-[-0.02em] md:text-[72px]", children: title }),
      /* @__PURE__ */ jsx7("p", { className: "mt-8 max-w-md text-base leading-relaxed text-muted-foreground md:text-[17px]", children: subtitle }),
    ...
    /* @__PURE__ */ jsx7("div", { className: "relative", children: /* @__PURE__ */ jsx7("video", { src: videoSrc, autoPlay: true, loop: true, muted: true, playsInline: true, className: "h-auto w-full" }) })
  ] }) });
}
...
function HeroImageOverlay({ layout, image, title, subtitle, primaryCta, secondaryCta }) {
  ...
  return /* @__PURE__ */ jsx8("div", { className: "px-4 md:px-8", children: /* @__PURE__ */ jsxs4("section", { className: "relative mx-auto w-full max-w-[1600px] overflow-hidden rounded-3xl bg-foreground", children: [
    ...
    layout === "stacked" ? /* @__PURE__ */ jsx8("div", { className: "relative px-6 py-20 text-background sm:px-10 md:px-16 md:py-32 lg:py-40", children: /* @__PURE__ */ jsxs4("div", { className: "max-w-3xl", children: [
      /* @__PURE__ */ jsx8("h2", { className: "font-display text-[40px] leading-[1.05] sm:text-5xl md:text-6xl lg:text-7xl", children: title }),
      ...
      /* @__PURE__ */ jsx8("h2", { className: "max-w-xl font-display text-[36px] leading-[1.05] text-background md:text-[56px]", children: title }),
...
function TrustedByLogos({ heading, logos }) {
  return /* @__PURE__ */ jsxs5("section", { id: "trusted-by", className: "mx-auto mt-32 max-w-[1280px] px-6", children: [
    /* @__PURE__ */ jsx9("h2", { className: "text-center font-display text-[32px] md:text-[40px]", children: heading }),
...
function StepCard({ className, index, title, body, ...props }) {
  return /* @__PURE__ */ jsxs6("li", { className: cn("p-8", className), ...props, children: [
    ...
    /* @__PURE__ */ jsx11("h3", { className: "mt-4 font-display text-lg", children: title }),
...
function FourStepsSection({ heading, description, image, imageAlt, steps }) {
  return /* @__PURE__ */ jsx12("section", { "aria-labelledby": "four-steps-title", className: "px-5 py-14 md:py-20", children: /* @__PURE__ */ jsx12("div", { className: "mx-auto max-w-[1280px]", children: /* @__PURE__ */ jsxs7("div", { className: "overflow-hidden rounded-3xl bg-gradient-to-br from-[oklch(0.97_0.01_240)] via-[oklch(0.91_0.07_240)] to-[oklch(0.82_0.13_240)]", children: [
    /* @__PURE__ */ jsxs7("div", { className: "grid items-center gap-8 px-6 pb-10 pt-10 md:grid-cols-[1.1fr_1fr] md:px-14 md:pb-16 md:pt-14", children: [
      /* @__PURE__ */ jsxs7("div", { children: [
        /* @__PURE__ */ jsx12("h2", { id: "four-steps-title", className: "max-w-2xl font-display text-[32px] leading-[1.05] md:text-[56px]", children: heading }),
        /* @__PURE__ */ jsx12("p", { className: "mt-6 max-w-xl text-muted-foreground md:text-[17px]", children: description })
      ] }),
      /* @__PURE__ */ jsx12("img", { src: image, alt: imageAlt, width: 700, height: 400, loading: "lazy", className: "w-full max-w-[560px] justify-self-end" })
    ] }),
    /* @__PURE__ */ jsx12("ol", { className: "grid border-t border-primary/20 sm:grid-cols-2 lg:grid-cols-4", children: steps.map((step, i) => /* @__PURE__ */ jsx12(
      StepCard,
      {
        index: i + 1,
        title: step.title,
...
function SingleIntegrationSection({
  ...
  return /* @__PURE__ */ jsx14("section", { id: "platform", className: "mt-32 w-full overflow-hidden bg-white pb-0 pt-24", children: /* @__PURE__ */ jsxs9("div", { className: "mx-auto max-w-[1280px] px-6", children: [
    /* @__PURE__ */ jsxs9("div", { className: "text-center", children: [
      /* @__PURE__ */ jsx14(Badge, { variant: "eyebrow", children: eyebrow }),
      /* @__PURE__ */ jsx14("h2", { className: "mt-6 font-display text-[44px] leading-[1.05] md:text-[64px]", children: heading })
    ] }),
    /* @__PURE__ */ jsxs9("div", { className: "mt-20 grid items-end gap-10 md:grid-cols-2", children: [
      /* @__PURE__ */ jsxs9("div", { className: "pb-24", children: [
        /* @__PURE__ */ jsx14("h3", { className: "font-display text-[28px]", children: subheading }),
...
function PlatformFeatureShowcase({ features }) {
  ...
  return /* @__PURE__ */ jsxs10(Fragment, { children: [
    /* @__PURE__ */ jsx15("div", { className: "flex flex-col gap-6 md:hidden", children: features.map((f) => /* @__PURE__ */ jsxs10("div", { className: "rounded-3xl bg-card p-6 shadow-sm", children: [
      /* @__PURE__ */ jsx15("h4", { className: "font-display text-xl", children: f.title }),
    ...
    /* @__PURE__ */ jsxs10("div", { className: "hidden items-stretch gap-6 md:grid md:grid-cols-[1.35fr_1fr]", children: [
      /* @__PURE__ */ jsx15("div", { className: "flex min-h-[460px] items-center justify-center overflow-hidden rounded-3xl bg-[oklch(0.97_0.02_240)] p-8", children: features.map((f) => /* @__PURE__ */ jsx15(
        "video",
        {
          src: f.video,
          autoPlay: true,
...
function IconCard({ className, icon: Icon, title, bullets, color, ...props }) {
  return /* @__PURE__ */ jsxs12("div", { className: cn("rounded-3xl bg-card p-8 shadow-sm", className), ...props, children: [
    /* @__PURE__ */ jsxs12("div", { className: "flex items-start justify-between gap-4", children: [
      /* @__PURE__ */ jsx17("h3", { className: "font-display text-2xl", children: title }),
      /* @__PURE__ */ jsx17(
        "div",
        {
...
function SecuritySection({ eyebrow, heading, description, schemeBadges, cards }) {
  return /* @__PURE__ */ jsxs13("section", { id: "security", className: "mx-auto mt-32 max-w-[1280px] px-6", children: [
    /* @__PURE__ */ jsxs13("div", { className: "text-center", children: [
      /* @__PURE__ */ jsx18(Badge, { variant: "eyebrow", children: eyebrow }),
      /* @__PURE__ */ jsx18("h2", { className: "mt-6 font-display text-[44px] leading-[1.05] md:text-[64px]", children: heading }),
...
function GlobalCoverageSection({ eyebrow, heading, features, floatingBadges }) {
  return /* @__PURE__ */ jsx19("section", { className: "mx-auto mt-32 max-w-[1280px] px-6", children: /* @__PURE__ */ jsxs14("div", { className: "grid items-center gap-12 md:grid-cols-2", children: [
...
function DataLeverageSection({ eyebrow, heading, description, items, reportingPeriods }) {
  return /* @__PURE__ */ jsxs15("section", { className: "mx-auto mt-32 max-w-[1280px] px-6", children: [
    /* @__PURE__ */ jsxs15("div", { className: "text-center", children: [
      /* @__PURE__ */ jsx20(Badge, { variant: "eyebrow", children: eyebrow }),
      /* @__PURE__ */ jsx20("h2", { className: "mt-6 font-display text-[44px] leading-[1.05] md:text-[56px]", children: heading }),
    ...
    /* @__PURE__ */ jsxs15("div", { className: "mt-16 grid gap-10 md:grid-cols-2", children: [
      /* @__PURE__ */ jsx20("ul", { className: "divide-y divide-border", children: items.map((d) => /* @__PURE__ */ jsxs15("li", { className: "py-8 first:pt-0", children: [
        /* @__PURE__ */ jsx20("h3", { className: "font-display text-2xl", children: d.title }),
...
function StatsSection({ heading, description, stats }) {
  return /* @__PURE__ */ jsx22("section", { className: "mx-auto mt-32 max-w-[1280px] px-6", children: /* @__PURE__ */ jsxs17("div", { className: "overflow-hidden rounded-3xl bg-gradient-to-br from-[oklch(0.93_0.05_240)] via-[oklch(0.88_0.09_240)] to-[oklch(0.82_0.13_240)] p-10 md:p-16", children: [
    /* @__PURE__ */ jsxs17("div", { className: "max-w-2xl", children: [
      /* @__PURE__ */ jsx22("h2", { className: "font-display text-[44px] leading-[1.05] md:text-[56px]", children: heading }),
...
import { Fragment as Fragment2, jsx as jsx23, jsxs as jsxs18 } from "react/jsx-runtime";
function IndustryCard({
  ...
  return /* @__PURE__ */ jsx23(
    "article",
    {
      ...
      ...props,
      children: layout === "stacked" ? /* @__PURE__ */ jsxs18(Fragment2, { children: [
        content,
        imageBlock
...
function IndustriesStackedSection({ eyebrow, heading, industries, ctaLabel, onCtaClick }) {
  return /* @__PURE__ */ jsx24("section", { className: "mt-32 w-full bg-surface", children: /* @__PURE__ */ jsxs19("div", { className: "mx-auto max-w-[1600px] px-6 py-16 md:px-10 md:py-20", children: [
    /* @__PURE__ */ jsxs19("div", { className: "text-center", children: [
      /* @__PURE__ */ jsx24(Badge, { variant: "eyebrow", children: eyebrow }),
      /* @__PURE__ */ jsx24("h2", { className: "mt-6 font-display text-[44px] leading-[1.05] md:text-[56px]", children: heading })
    ] }),
...
function IndustriesGridSection({ eyebrow, heading, industries, ctaLabel, onCtaClick }) {
  return /* @__PURE__ */ jsx25("section", { className: "mt-32 w-full bg-surface", children: /* @__PURE__ */ jsxs20("div", { className: "mx-auto max-w-[1600px] px-6 py-16 md:px-10 md:py-20", children: [
    /* @__PURE__ */ jsxs20("div", { className: "text-center", children: [
      /* @__PURE__ */ jsx25(Badge, { variant: "eyebrow", children: eyebrow }),
      /* @__PURE__ */ jsx25("h2", { className: "mt-6 font-display text-[44px] leading-[1.05] md:text-[56px]", children: heading })
    ] }),
...
function ContactSection({
  ...
  return /* @__PURE__ */ jsx31("section", { id: "contact", className: "mx-auto mt-32 max-w-[1280px] px-6", children: /* @__PURE__ */ jsxs23("div", { className: "grid items-start gap-12 md:grid-cols-2", children: [
    ...
    /* @__PURE__ */ jsxs23("div", { className: "rounded-3xl bg-card p-8 shadow-[0_20px_60px_-20px_rgba(0,0,0,0.1)] md:p-10", children: [
      /* @__PURE__ */ jsx31("h3", { className: "font-display text-3xl", children: formHeading }),
...
var AccordionItem = React8.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx32(AccordionPrimitive.Item, { ref, className: cn("border-b", className), ...props }));
AccordionItem.displayName = "AccordionItem";
var AccordionTrigger = React8.forwardRef(({ className, children, ...props }, ref) => /* @__PURE__ */ jsx32(AccordionPrimitive.Header, { className: "flex", children: /* @__PURE__ */ jsxs24(
...
var AccordionContent = React8.forwardRef(({ className, children, ...props }, ref) => /* @__PURE__ */ jsx32(
