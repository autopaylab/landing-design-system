...
function Navbar({
  ...
  return /* @__PURE__ */ jsx19("header", { className: "sticky top-5 z-40 mx-auto w-full max-w-[1280px] px-6", children: /* @__PURE__ */ jsxs11("div", { className: "rounded-xl bg-background shadow-[0_10px_40px_-12px_rgba(0,0,0,0.12)]", children: [
    /* @__PURE__ */ jsxs11("div", { className: "flex items-center justify-between gap-6 px-6 py-3", children: [
      ...
      /* @__PURE__ */ jsxs11("div", { className: "flex items-center gap-2", children: [
        ...
        /* @__PURE__ */ jsx19(Button, { type: "button", variant: "lime", className: "hidden px-6 py-2.5 text-[17px] md:inline-flex", onClick: onSignInClick, children: signInLabel }),
        ...
        /* @__PURE__ */ jsx19(
          "button",
          {
            ...
            children: isMenuOpen ? /* @__PURE__ */ jsx19(X, { className: "h-5 w-5" }) : /* @__PURE__ */ jsx19(Menu, { className: "h-5 w-5" })
          }
        )
      ] })
    ] }),
    isMenuOpen && /* @__PURE__ */ jsxs11(
      "nav",
      {
        id: menuId,
        ...
        children: [
          navItems.map((item) => /* @__PURE__ */ jsx19(
            Link,
            {
              variant: "nav",
              href: item.href,
          ...
          /* @__PURE__ */ jsxs11("div", { className: "mt-3 flex flex-col gap-2", children: [
            /* @__PURE__ */ jsx19(Button, { type: "button", variant: "outline", className: "w-full py-2.5 text-[17px]", onClick: onLoginClick, children: loginLabel }),
            /* @__PURE__ */ jsx19(Button, { type: "button", variant: "lime", className: "w-full py-2.5 text-[17px]", onClick: onSignInClick, children: signInLabel })
          ] }),
          languageLabel && /* @__PURE__ */ jsxs11(
            "button",
            {
...
function GlobalCoverageSection({ eyebrow, heading, features, floatingBadges }) {
  return /* @__PURE__ */ jsx28("section", { className: "mx-auto mt-32 max-w-[1280px] px-6", children: /* @__PURE__ */ jsxs20("div", { className: "grid items-center gap-12 md:grid-cols-2", children: [
    /* @__PURE__ */ jsxs20("div", { children: [
      ...
      /* @__PURE__ */ jsx28("ul", { className: "mt-12 space-y-8", children: features.map((f) => (
        ...
        /* @__PURE__ */ jsx28(IconFeatureItem, { headingLevel: "h3", ...f }, f.title)
      )) })
    ] }),
