...
var FormField = React8.forwardRef(
  ({ label, id, ...inputProps }, ref) => /* @__PURE__ */ jsxs3("label", { className: "block", children: [
    /* @__PURE__ */ jsx12(Label, { children: label }),
    /* @__PURE__ */ jsx12(Input, { ref, id, className: "mt-2", ...inputProps })
  ] })
);
...
var TextareaField = React9.forwardRef(
  ({ label, id, ...textareaProps }, ref) => /* @__PURE__ */ jsxs4("label", { className: "block", children: [
    /* @__PURE__ */ jsx13(Label, { children: label }),
    /* @__PURE__ */ jsx13(Textarea, { ref, id, className: "mt-2", ...textareaProps })
  ] })
);
...
var SelectField = React10.forwardRef(
  ({ label, id, ...selectProps }, ref) => /* @__PURE__ */ jsxs5("label", { className: "block", children: [
    /* @__PURE__ */ jsx14(Label, { children: label }),
    /* @__PURE__ */ jsx14(Select, { ref, id, className: "mt-2", ...selectProps })
  ] })
);
...
var ConsentCheckboxField = React11.forwardRef(
  ({ consentText, controllerText, moreHref = "#", ...props }, ref) => /* @__PURE__ */ jsxs6("label", { className: "flex gap-3 text-xs text-muted-foreground", children: [
    /* @__PURE__ */ jsx15(Checkbox, { ref, ...props }),
    /* @__PURE__ */ jsxs6("span", { children: [
      consentText,
      /* @__PURE__ */ jsxs6("span", { className: "mt-2 block text-[11px]", children: [
        controllerText,
        " ",
        /* @__PURE__ */ jsx15(Link, { variant: "underline", href: moreHref, children: "More" })
      ] })
    ] })
  ] })
);
...
function StatBlock({ className, eyebrow = "UP TO", value, label, ...props }) {
  return /* @__PURE__ */ jsxs7("div", { className: cn("bg-transparent pr-6", className), ...props, children: [
    /* @__PURE__ */ jsx16("div", { className: "text-[10px] font-semibold uppercase tracking-wider text-muted-foreground", children: eyebrow }),
    /* @__PURE__ */ jsx16("div", { className: "mt-3 font-display text-[56px] leading-none md:text-[72px]", children: value }),
    /* @__PURE__ */ jsx16("div", { className: "mt-6 text-sm text-muted-foreground", children: label })
  ] });
}
...
function IconFeatureItem({
  ...
  return /* @__PURE__ */ jsxs8("li", { className: cn("flex gap-4", className), ...props, children: [
    /* @__PURE__ */ jsx17(Icon, { className: cn("mt-1 h-5 w-5 shrink-0", iconClassName) }),
    /* @__PURE__ */ jsxs8("div", { children: [
      /* @__PURE__ */ jsx17(Heading, { className: "font-display text-h6", children: title }),
      /* @__PURE__ */ jsx17("p", { className: "mt-1 text-sm text-muted-foreground", children: description })
    ] })
  ] });
}
...
function BulletItem({ className, children, ...props }) {
  return /* @__PURE__ */ jsxs9("li", { className: cn("flex gap-3", className), ...props, children: [
    /* @__PURE__ */ jsx18("span", { className: "mt-2 inline-block h-1 w-1 shrink-0 rounded-full bg-muted-foreground" }),
    children
  ] });
}
...
function IconCard({ className, icon: Icon, title, bullets, color, ...props }) {
  return /* @__PURE__ */ jsxs10("div", { className: cn("rounded-3xl bg-card p-8 shadow-sm", className), ...props, children: [
    /* @__PURE__ */ jsxs10("div", { className: "flex items-start justify-between gap-4", children: [
      /* @__PURE__ */ jsx19("h3", { className: "font-display text-h4", children: title }),
      /* @__PURE__ */ jsx19(
        "div",
        {
          className: "grid h-12 w-12 shrink-0 place-items-center rounded-xl",
          style: { background: `linear-gradient(135deg, ${color}, color-mix(in oklab, ${color} 40%, white))` },
          children: /* @__PURE__ */ jsx19(Icon, { className: "h-5 w-5 text-foreground" })
        }
      )
    ] }),
    /* @__PURE__ */ jsx19("ul", { className: "mt-8 space-y-2 text-muted-foreground", children: bullets.map((bullet) => /* @__PURE__ */ jsx19(BulletItem, { children: bullet }, bullet)) })
  ] });
}
...
function StepCard({ className, index, title, body, ...props }) {
  return /* @__PURE__ */ jsxs11("li", { className: cn("p-8", className), ...props, children: [
    /* @__PURE__ */ jsx20(StepNumber, { value: index }),
    /* @__PURE__ */ jsx20("h3", { className: "mt-4 font-display text-h6", children: title }),
    /* @__PURE__ */ jsx20("p", { className: "mt-2 text-sm text-muted-foreground", children: body })
  ] });
}
...
function IndustryCard({
  ...
  const imageBlock = /* @__PURE__ */ jsx21(
    "div",
    {
      className: cn(
        "bg-cover bg-center",
  ...
  const content = /* @__PURE__ */ jsxs12("div", { className: cn(layout === "stacked" ? "flex flex-col justify-between p-10 md:p-12" : "p-8"), children: [
    ...
    /* @__PURE__ */ jsxs12("div", { className: layout === "grid" ? "mt-4" : void 0, children: [
      /* @__PURE__ */ jsx21("p", { className: cn("max-w-md text-sm leading-relaxed text-foreground/75", layout === "stacked" && "mt-8"), children: description }),
      /* @__PURE__ */ jsx21(
        Button,
        {
          type: "button",
    ...
    "article",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs13("div", { className: "flex flex-col justify-between p-10 md:p-12", children: [
          /* @__PURE__ */ jsx22("h3", { className: "font-display text-h3 whitespace-pre-line", children: title }),
          /* @__PURE__ */ jsxs13("div", { className: "mt-8", children: [
            /* @__PURE__ */ jsx22("p", { className: "max-w-md text-sm leading-relaxed text-foreground/75", children: description }),
            /* @__PURE__ */ jsxs13("div", { className: "mt-8 flex flex-wrap gap-3", children: [
              /* @__PURE__ */ jsx22(Button, { type: "button", variant: "solid", size: "xs", onClick: primaryCta.onClick, children: primaryCta.label }),
              /* @__PURE__ */ jsx22(
                Button,
                {
                  type: "button",
...
function FaqItem({ value, question, answer }) {
  return /* @__PURE__ */ jsxs14(AccordionItem, { value, className: "rounded-2xl border-0 bg-card px-6 py-1 md:px-8", children: [
...
function Navbar({
  ...
  return /* @__PURE__ */ jsx25("header", { className: "sticky top-5 z-40 mx-auto w-full max-w-[1280px] px-6", children: /* @__PURE__ */ jsxs16("div", { className: "rounded-xl bg-background shadow-[0_10px_40px_-12px_rgba(0,0,0,0.12)]", children: [
    /* @__PURE__ */ jsxs16("div", { className: "flex items-center justify-between gap-6 px-6 py-3", children: [
      /* @__PURE__ */ jsx25("a", { href: homeHref, className: "flex items-center", children: /* @__PURE__ */ jsx25(Logo, { src: logoSrc, alt: logoAlt, size: "md" }) }),
      /* @__PURE__ */ jsx25("nav", { "aria-label": navAriaLabel, className: "hidden flex-1 items-center justify-center gap-2 md:flex", children: navItems.map((item) => /* @__PURE__ */ jsx25(Link, { variant: "nav", href: item.href, children: item.label }, item.label)) }),
      /* @__PURE__ */ jsxs16("div", { className: "flex items-center gap-2", children: [
        ...
        /* @__PURE__ */ jsx25(Button, { type: "button", variant: "lime", className: "hidden px-6 py-2.5 text-[17px] md:inline-flex", onClick: onSignInClick, children: signInLabel }),
        languageLabel && /* @__PURE__ */ jsxs16(
          "button",
          {
            type: "button",
            ...
            children: [
              /* @__PURE__ */ jsx25("span", { className: "inline-flex h-9 w-9 items-center justify-center overflow-hidden rounded-lg text-base", children: languageLabel }),
              /* @__PURE__ */ jsx25(ChevronDown3, { className: "h-4 w-4" })
            ]
          }
        ),
        /* @__PURE__ */ jsx25(
          "button",
          {
            ...
            children: isMenuOpen ? /* @__PURE__ */ jsx25(X, { className: "h-5 w-5" }) : /* @__PURE__ */ jsx25(Menu, { className: "h-5 w-5" })
          }
        )
      ] })
    ] }),
    isMenuOpen && /* @__PURE__ */ jsxs16(
      "nav",
      {
        id: menuId,
        ...
        children: [
          navItems.map((item) => /* @__PURE__ */ jsx25(
            Link,
            {
              variant: "nav",
              href: item.href,
          ...
          /* @__PURE__ */ jsxs16("div", { className: "mt-3 flex flex-col gap-2", children: [
            /* @__PURE__ */ jsx25(Button, { type: "button", variant: "outline", className: "w-full py-2.5 text-[17px]", onClick: onLoginClick, children: loginLabel }),
            /* @__PURE__ */ jsx25(Button, { type: "button", variant: "lime", className: "w-full py-2.5 text-[17px]", onClick: onSignInClick, children: signInLabel })
          ] }),
          languageLabel && /* @__PURE__ */ jsxs16(
            "button",
            {
...
function Footer({
  ...
  return /* @__PURE__ */ jsxs17("footer", { className: "mt-24", children: [
    /* @__PURE__ */ jsx26("section", { className: "relative mx-4 overflow-hidden rounded-t-3xl md:mx-8", children: /* @__PURE__ */ jsx26(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxs17("div", { className: "absolute inset-0 grid grid-cols-1 items-start gap-8 px-8 py-12 md:grid-cols-2 md:px-16 md:py-16", children: [
          /* @__PURE__ */ jsx26("h3", { className: "font-display text-h2 text-white", children: ctaHeading }),
          /* @__PURE__ */ jsx26("p", { className: "font-display text-3xl text-white md:text-right md:text-[44px]", children: ctaSubheading })
        ] })
      }
    ) }),
    /* @__PURE__ */ jsxs17("section", { className: "mx-4 rounded-b-3xl bg-lime px-8 py-10 text-lime-foreground md:mx-8 md:px-16", children: [
      /* @__PURE__ */ jsxs17("div", { className: "flex items-start justify-between gap-8", children: [
        /* @__PURE__ */ jsx26(Logo, { src: logoSrc, alt: logoAlt, size: "sm" }),
        /* @__PURE__ */ jsx26("div", { className: "flex gap-4", children: socialLinks.map(({ label, href, icon: Icon }) => /* @__PURE__ */ jsx26("a", { href, "aria-label": label, className: "hover:opacity-70", children: /* @__PURE__ */ jsx26(Icon, { className: "h-5 w-5" }) }, label)) })
      ] }),
      /* @__PURE__ */ jsxs17("div", { className: "mt-10 grid items-end gap-8 md:grid-cols-[1.4fr_2fr_1fr]", children: [
        /* @__PURE__ */ jsx26("p", { className: "font-display text-3xl leading-[1.1] md:text-[38px]", children: tagline }),
        /* @__PURE__ */ jsx26("nav", { "aria-label": navAriaLabel, className: "flex flex-wrap items-end gap-x-10 gap-y-3 text-base font-medium", children: navItems.map((item) => /* @__PURE__ */ jsx26(Link, { variant: "underline", href: item.href, children: item.label }, item.label)) }),
        /* @__PURE__ */ jsx26("address", { className: "text-sm not-italic leading-relaxed md:text-right", children: address })
      ] }),
      /* @__PURE__ */ jsxs17("div", { className: "mt-10 flex flex-wrap items-center justify-between gap-3 border-t border-lime-foreground/20 pt-5 text-xs", children: [
        /* @__PURE__ */ jsx26("span", { children: legalText }),
        /* @__PURE__ */ jsx26("div", { className: "flex items-center gap-4 opacity-80", children: schemeBadges.map((badge) => /* @__PURE__ */ jsx26("span", { className: "font-bold", children: badge }, badge)) })
      ] })
    ] })
  ] });
}
...
function HeroVideoSplit({ eyebrow, title, subtitle, ctaLabel, ctaHref, videoSrc }) {
  return /* @__PURE__ */ jsx27("section", { className: "mx-auto max-w-[1280px] px-6 pt-16 md:pt-24", children: /* @__PURE__ */ jsxs18("div", { className: "grid items-center gap-10 md:grid-cols-2", children: [
    /* @__PURE__ */ jsxs18("div", { children: [
      eyebrow && /* @__PURE__ */ jsx27("div", { className: "mb-6", children: /* @__PURE__ */ jsx27(Badge, { variant: "eyebrow", children: eyebrow }) }),
      /* @__PURE__ */ jsx27("h1", { className: "font-display text-h1", children: title }),
      /* @__PURE__ */ jsx27("p", { className: "mt-8 max-w-md text-base leading-relaxed text-muted-foreground md:text-[17px]", children: subtitle }),
      /* @__PURE__ */ jsx27("div", { className: "mt-10", children: /* @__PURE__ */ jsx27(Button, { asChild: true, variant: "lime", size: "lg", children: /* @__PURE__ */ jsx27("a", { href: ctaHref, children: ctaLabel }) }) })
    ] }),
    /* @__PURE__ */ jsx27("div", { className: "relative", children: /* @__PURE__ */ jsx27("video", { src: videoSrc, autoPlay: true, loop: true, muted: true, playsInline: true, className: "h-auto w-full" }) })
  ] }) });
}
...
function HeroImageOverlay({ layout, image, title, subtitle, primaryCta, secondaryCta }) {
  const ctas = /* @__PURE__ */ jsxs19("div", { className: "flex flex-col gap-3 sm:flex-row", children: [
    /* @__PURE__ */ jsx28(Button, { asChild: true, variant: "lime", size: "lg", children: /* @__PURE__ */ jsx28("a", { href: primaryCta.href, children: primaryCta.label }) }),
    /* @__PURE__ */ jsx28(Button, { asChild: true, variant: "outline-inverse", size: "lg", children: /* @__PURE__ */ jsx28("a", { href: secondaryCta.href, children: secondaryCta.label }) })
  ] });
  return /* @__PURE__ */ jsx28("div", { className: "px-4 md:px-8", children: /* @__PURE__ */ jsxs19("section", { className: "relative mx-auto w-full max-w-[1600px] overflow-hidden rounded-3xl bg-foreground", children: [
    /* @__PURE__ */ jsx28("img", { src: image, alt: "", "aria-hidden": "true", loading: "lazy", className: "absolute inset-0 size-full object-cover" }),
    /* @__PURE__ */ jsx28(
      "div",
      {
        "aria-hidden": "true",
    ...
    layout === "stacked" ? /* @__PURE__ */ jsx28("div", { className: "relative px-6 py-20 text-background sm:px-10 md:px-16 md:py-32 lg:py-40", children: /* @__PURE__ */ jsxs19("div", { className: "max-w-3xl", children: [
      /* @__PURE__ */ jsx28("h2", { className: "font-display text-h1", children: title }),
      subtitle && /* @__PURE__ */ jsx28("p", { className: "mt-6 max-w-2xl text-base text-background/80 md:text-xl", children: subtitle }),
      /* @__PURE__ */ jsx28("div", { className: "mt-9", children: ctas })
    ] }) }) : /* @__PURE__ */ jsx28("div", { className: "relative px-6 py-20 sm:px-10 md:px-14 md:py-28", children: /* @__PURE__ */ jsxs19("div", { className: "grid gap-10 md:grid-cols-2 md:items-center", children: [
      /* @__PURE__ */ jsx28("h2", { className: "max-w-xl font-display text-h2 text-background", children: title }),
      /* @__PURE__ */ jsx28("div", { className: "md:justify-self-end", children: ctas })
    ] }) })
  ] }) });
}
...
function TrustedByLogos({ heading, logos }) {
  return /* @__PURE__ */ jsxs20("section", { id: "trusted-by", className: "mx-auto mt-16 max-w-[1280px] px-6 md:mt-32", children: [
    /* @__PURE__ */ jsx29("h2", { className: "text-center font-display text-h3", children: heading }),
    /* @__PURE__ */ jsx29("div", { className: "mt-12 flex flex-wrap items-center justify-center gap-x-16 gap-y-10", children: logos.map((l) => /* @__PURE__ */ jsx29(
      "img",
      {
        src: l.src,
        alt: l.alt,
...
function FourStepsSection({ heading, description, image, imageAlt, steps }) {
  return /* @__PURE__ */ jsx30("section", { "aria-labelledby": "four-steps-title", className: "px-5 py-14 md:py-20", children: /* @__PURE__ */ jsx30("div", { className: "mx-auto max-w-[1280px]", children: /* @__PURE__ */ jsxs21("div", { className: "overflow-hidden rounded-3xl bg-gradient-to-br from-[oklch(0.97_0.01_240)] via-[oklch(0.91_0.07_240)] to-[oklch(0.82_0.13_240)]", children: [
    /* @__PURE__ */ jsxs21("div", { className: "grid items-center gap-8 px-6 pb-10 pt-10 md:grid-cols-[1.1fr_1fr] md:px-14 md:pb-16 md:pt-14", children: [
      /* @__PURE__ */ jsxs21("div", { children: [
        /* @__PURE__ */ jsx30("h2", { id: "four-steps-title", className: "max-w-2xl font-display text-h2", children: heading }),
        /* @__PURE__ */ jsx30("p", { className: "mt-6 max-w-xl text-muted-foreground md:text-[17px]", children: description })
      ] }),
      /* @__PURE__ */ jsx30("img", { src: image, alt: imageAlt, width: 700, height: 400, loading: "lazy", className: "w-full max-w-[560px] justify-self-end" })
    ] }),
    /* @__PURE__ */ jsx30("ol", { className: "grid border-t border-primary/20 sm:grid-cols-2 lg:grid-cols-4", children: steps.map((step, i) => /* @__PURE__ */ jsx30(
      StepCard,
      {
        index: i + 1,
        title: step.title,
...
function SingleIntegrationSection({
  ...
  return /* @__PURE__ */ jsx31("section", { id: "platform", className: "mt-16 w-full overflow-hidden bg-white pb-0 pt-24 md:mt-32", children: /* @__PURE__ */ jsxs22("div", { className: "mx-auto max-w-[1280px] px-6", children: [
    ...
    /* @__PURE__ */ jsxs22("div", { className: "mt-20 grid items-end gap-10 md:grid-cols-2", children: [
      /* @__PURE__ */ jsxs22("div", { className: "pb-24", children: [
        /* @__PURE__ */ jsx31("h3", { className: "font-display text-h4", children: subheading }),
        /* @__PURE__ */ jsx31("p", { className: "mt-2 text-muted-foreground", children: subheadingCaption }),
        /* @__PURE__ */ jsx31("ul", { className: "mt-10 space-y-8", children: features.map((f) => /* @__PURE__ */ jsx31(IconFeatureItem, { ...f }, f.title)) })
      ] }),
      /* @__PURE__ */ jsx31("div", { className: "flex justify-center self-end md:justify-end", children: /* @__PURE__ */ jsx31("video", { src: videoSrc, autoPlay: true, muted: true, loop: true, playsInline: true, className: "block h-auto w-full max-w-[720px] object-contain" }) })
    ] })
  ] }) });
}
...
function PlatformFeatureShowcase({ features }) {
  ...
  return /* @__PURE__ */ jsxs23(Fragment2, { children: [
    /* @__PURE__ */ jsx32("div", { className: "flex flex-col gap-6 md:hidden", children: features.map((f) => /* @__PURE__ */ jsxs23("div", { className: "rounded-3xl bg-card p-6 shadow-sm", children: [
      /* @__PURE__ */ jsx32("h4", { className: "font-display text-h5", children: f.title }),
      /* @__PURE__ */ jsx32("p", { className: "mt-2 text-[15px] leading-relaxed text-muted-foreground", children: f.desc }),
      /* @__PURE__ */ jsx32("div", { className: "mt-5 flex items-center justify-center overflow-hidden rounded-lg bg-[oklch(0.97_0.02_240)] p-4", children: /* @__PURE__ */ jsx32("video", { src: f.video, autoPlay: true, muted: true, loop: true, playsInline: true, preload: "metadata", className: "w-full max-w-full object-contain" }) })
    ] }, f.key)) }),
    /* @__PURE__ */ jsxs23("div", { className: "hidden items-stretch gap-6 md:grid md:grid-cols-[1.35fr_1fr]", children: [
      /* @__PURE__ */ jsx32("div", { className: "flex min-h-[460px] items-center justify-center overflow-hidden rounded-3xl bg-[oklch(0.97_0.02_240)] p-8", children: features.map((f) => /* @__PURE__ */ jsx32("div", { role: "tabpanel", id: panelId(f.key), "aria-labelledby": tabId(f.key), hidden: shown !== f.key, children: /* @__PURE__ */ jsx32(
        "video",
        {
          src: f.video,
          autoPlay: true,
      ...
      /* @__PURE__ */ jsx32("div", { className: "flex flex-col gap-5", role: "tablist", "aria-orientation": "vertical", children: features.map((f, i) => {
        ...
        return /* @__PURE__ */ jsxs23(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsx32("span", { className: "block font-display text-2xl", children: f.title }),
              /* @__PURE__ */ jsx32("span", { className: "mt-3 block text-[15px] leading-relaxed text-muted-foreground", children: f.desc })
            ]
          },
          f.key
        );
...
function SecuritySection({ eyebrow, heading, description, schemeBadges, cards }) {
  return /* @__PURE__ */ jsxs24("section", { id: "security", className: "mx-auto mt-16 max-w-[1280px] px-6 md:mt-32", children: [
    /* @__PURE__ */ jsxs24("div", { className: "text-center", children: [
      ...
      /* @__PURE__ */ jsx33("p", { className: "mx-auto mt-6 max-w-2xl text-muted-foreground md:text-[17px]", children: description })
    ] }),
    /* @__PURE__ */ jsx33("div", { className: "mt-12 flex flex-wrap items-center justify-center gap-x-12 gap-y-6 opacity-70 grayscale", children: schemeBadges.map((label) => /* @__PURE__ */ jsx33("span", { className: "text-sm font-bold text-foreground/60", children: label }, label)) }),
    /* @__PURE__ */ jsx33("div", { className: "mt-12 grid gap-6 md:grid-cols-2", children: cards.map((c) => /* @__PURE__ */ jsx33(IconCard, { ...c }, c.title)) })
  ] });
}
...
function GlobalCoverageSection({ eyebrow, heading, features, floatingBadges }) {
  return /* @__PURE__ */ jsx34("section", { className: "mx-auto mt-16 max-w-[1280px] px-6 md:mt-32", children: /* @__PURE__ */ jsxs25("div", { className: "grid items-center gap-12 md:grid-cols-2", children: [
    /* @__PURE__ */ jsxs25("div", { children: [
      ...
      /* @__PURE__ */ jsx34("ul", { className: "mt-12 space-y-8", children: features.map((f) => (
        ...
        /* @__PURE__ */ jsx34(IconFeatureItem, { headingLevel: "h3", ...f }, f.title)
      )) })
    ] }),
    /* @__PURE__ */ jsxs25("div", { className: "relative aspect-square rounded-3xl bg-gradient-to-br from-muted to-background", children: [
      /* @__PURE__ */ jsx34("div", { className: "absolute right-8 top-8 grid h-20 w-20 place-items-center rounded-full bg-card shadow-lg", children: /* @__PURE__ */ jsx34("div", { className: "h-9 w-6 rounded-t-full bg-[oklch(0.6_0.22_255)]" }) }),
      floatingBadges.map((b) => /* @__PURE__ */ jsx34(
        "div",
        {
...
function DataLeverageSection({ eyebrow, heading, description, items, reportingPeriods }) {
  return /* @__PURE__ */ jsxs26("section", { className: "mx-auto mt-16 max-w-[1280px] px-6 md:mt-32", children: [
    ...
    /* @__PURE__ */ jsxs26("div", { className: "mt-16 grid gap-10 md:grid-cols-2", children: [
      /* @__PURE__ */ jsx35("ul", { className: "divide-y divide-border", children: items.map((d) => /* @__PURE__ */ jsxs26("li", { className: "py-8 first:pt-0", children: [
        /* @__PURE__ */ jsx35("h3", { className: "font-display text-h4", children: d.title }),
        /* @__PURE__ */ jsx35("p", { className: "mt-3 text-sm leading-relaxed text-muted-foreground md:text-base", children: d.desc })
      ] }, d.title)) }),
      /* @__PURE__ */ jsxs26("div", { className: "relative min-h-[480px] rounded-3xl bg-gradient-to-br from-[oklch(0.9_0.06_280)] to-[oklch(0.95_0.04_260)] p-6", children: [
        /* @__PURE__ */ jsxs26("div", { className: "absolute right-6 top-6 w-[85%] rounded-2xl bg-card p-4 shadow-xl", children: [
          /* @__PURE__ */ jsxs26("div", { className: "flex items-center justify-between text-[10px] text-muted-foreground", children: [
            /* @__PURE__ */ jsx35("span", { className: "rounded bg-muted px-2 py-1", children: "Number of transactions \u25BE" }),
            /* @__PURE__ */ jsx35("span", { className: "rounded bg-muted px-2 py-1", children: "Operator" }),
            /* @__PURE__ */ jsx35("span", { className: "rounded bg-muted px-2 py-1", children: "Method" })
          ] }),
          /* @__PURE__ */ jsxs26("svg", { viewBox: "0 0 300 100", className: "mt-3 h-24 w-full", children: [
            /* @__PURE__ */ jsx35("path", { d: "M0,60 Q40,20 80,50 T160,40 T240,70 T300,30", stroke: "oklch(0.55 0.2 255)", strokeWidth: "2", fill: "none" }),
            /* @__PURE__ */ jsx35("path", { d: "M0,70 Q40,40 80,60 T160,55 T240,40 T300,60", stroke: "oklch(0.7 0.18 140)", strokeWidth: "2", fill: "none" }),
            /* @__PURE__ */ jsx35("path", { d: "M0,50 Q40,70 80,45 T160,65 T240,55 T300,45", stroke: "oklch(0.65 0.22 25)", strokeWidth: "2", fill: "none" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs26("div", { className: "absolute bottom-6 left-6 w-[88%] rounded-2xl bg-card p-4 shadow-xl", children: [
          /* @__PURE__ */ jsxs26("div", { className: "flex items-center justify-between border-b border-border pb-2 text-[10px] font-semibold", children: [
            /* @__PURE__ */ jsx35("span", { children: "Autopay" }),
            /* @__PURE__ */ jsx35("span", { className: "text-muted-foreground", children: "Reporting Periods" })
          ] }),
          /* @__PURE__ */ jsx35("div", { className: "mt-3 space-y-1.5 text-[9px]", children: reportingPeriods.map((p) => /* @__PURE__ */ jsxs26("div", { className: "flex items-center justify-between border-b border-border/50 py-1", children: [
            /* @__PURE__ */ jsx35("span", { children: p.month }),
            /* @__PURE__ */ jsx35("span", { className: "rounded-full bg-[oklch(0.92_0.15_85)] px-2 py-0.5 text-[8px] font-medium", children: p.status }),
            /* @__PURE__ */ jsx35("span", { className: "text-muted-foreground", children: p.date })
          ] }, p.month)) })
        ] })
      ] })
    ] })
...
function StatsSection({ heading, description, stats }) {
  return /* @__PURE__ */ jsx36("section", { className: "mx-auto mt-16 max-w-[1280px] px-6 md:mt-32", children: /* @__PURE__ */ jsxs27("div", { className: "overflow-hidden rounded-3xl bg-gradient-to-br from-[oklch(0.93_0.05_240)] via-[oklch(0.88_0.09_240)] to-[oklch(0.82_0.13_240)] p-10 md:p-16", children: [
    /* @__PURE__ */ jsxs27("div", { className: "max-w-2xl", children: [
      /* @__PURE__ */ jsx36("h2", { className: "font-display text-h2", children: heading }),
      /* @__PURE__ */ jsx36("p", { className: "mt-6 text-muted-foreground md:text-[17px]", children: description })
    ] }),
    /* @__PURE__ */ jsx36("div", { className: "mt-16 grid grid-cols-2 gap-px md:grid-cols-4", children: stats.map((s) => /* @__PURE__ */ jsx36(StatBlock, { ...s }, s.label)) })
  ] }) });
}
...
function IndustriesStackedSection({ eyebrow, heading, industries, ctaLabel, onCtaClick }) {
  return /* @__PURE__ */ jsx37("section", { className: "mt-16 w-full bg-surface md:mt-32", children: /* @__PURE__ */ jsxs28("div", { className: "mx-auto max-w-[1600px] px-6 py-16 md:px-10 md:py-20", children: [
    ...
    /* @__PURE__ */ jsx37("div", { className: "mt-12", children: industries.map((ind, i) => /* @__PURE__ */ jsx37(
      IndustryCard,
      {
        layout: "stacked",
        name: ind.name,
...
function IndustriesGridSection({ eyebrow, heading, industries, ctaLabel, onCtaClick }) {
  return /* @__PURE__ */ jsx38("section", { className: "mt-16 w-full bg-surface md:mt-32", children: /* @__PURE__ */ jsxs29("div", { className: "mx-auto max-w-[1600px] px-6 py-16 md:px-10 md:py-20", children: [
    ...
    /* @__PURE__ */ jsx38("div", { className: "mt-12 grid gap-6 md:grid-cols-3", children: industries.map((ind) => /* @__PURE__ */ jsx38(
      IndustryCard,
      {
        layout: "grid",
        name: ind.name,
...
function OverlappingCardsSection({ eyebrow, heading, cards }) {
  return /* @__PURE__ */ jsx39("section", { className: "mt-16 w-full bg-surface md:mt-32", children: /* @__PURE__ */ jsxs30("div", { className: "mx-auto max-w-[1600px] px-6 py-16 md:px-10 md:py-20", children: [
    ...
    /* @__PURE__ */ jsx39("div", { className: "mt-12", children: cards.map((c, i) => /* @__PURE__ */ jsx39(
      OverlapCard,
      {
        title: c.title,
...
function ContactSection({
  ...
  return /* @__PURE__ */ jsx40("section", { id: "contact", className: "mx-auto mt-16 max-w-[1280px] px-6 md:mt-32", children: /* @__PURE__ */ jsxs31("div", { className: "grid items-start gap-12 md:grid-cols-2", children: [
    /* @__PURE__ */ jsxs31("div", { children: [
      /* @__PURE__ */ jsx40("h2", { className: "font-display text-h2", children: heading }),
      /* @__PURE__ */ jsx40("p", { className: "mt-6 max-w-md text-muted-foreground md:text-[17px]", children: description })
    ] }),
    /* @__PURE__ */ jsxs31("div", { className: "rounded-3xl bg-card p-8 shadow-[0_20px_60px_-20px_rgba(0,0,0,0.1)] md:p-10", children: [
      /* @__PURE__ */ jsx40("h3", { className: "font-display text-h4", children: formHeading }),
      /* @__PURE__ */ jsxs31("form", { className: "mt-6 space-y-5", onSubmit: onSubmit ?? ((e) => e.preventDefault()), children: [
        /* @__PURE__ */ jsxs31("div", { className: "grid grid-cols-2 gap-4", children: [
          /* @__PURE__ */ jsx40(FormField, { label: "First name", name: "firstName", placeholder: "Jane" }),
          /* @__PURE__ */ jsx40(FormField, { label: "Last name", name: "lastName", placeholder: "Doe" })
        ] }),
        /* @__PURE__ */ jsx40(FormField, { label: "Phone number", name: "phone", placeholder: "123456789" }),
        /* @__PURE__ */ jsx40(FormField, { label: "Business e-mail", name: "email", type: "email", placeholder: "jane@example.com" }),
        /* @__PURE__ */ jsx40(ConsentCheckboxField, { name: "consent", consentText, controllerText }),
        /* @__PURE__ */ jsx40(Button, { type: "submit", variant: "solid", className: "w-full py-4 text-sm", children: submitLabel })
      ] })
    ] })
  ] }) });
}
...
function FaqAccordionSection({ heading, entries }) {
  return /* @__PURE__ */ jsx41("section", { id: "faq", "aria-labelledby": "faq-title", className: "bg-surface px-5 py-14 md:py-20", children: /* @__PURE__ */ jsxs32("div", { className: "mx-auto max-w-[1280px]", children: [
    /* @__PURE__ */ jsx41("h2", { id: "faq-title", className: "font-display text-h2", children: heading }),
    /* @__PURE__ */ jsx41(Accordion, { type: "single", collapsible: true, className: "mt-8 flex w-full flex-col gap-3", children: entries.map((entry, i) => /* @__PURE__ */ jsx41(FaqItem, { value: `item-${i}`, question: entry.question, answer: entry.answer }, entry.question)) })
  ] }) });
}
...
function PromoCtaSection({
  ...
  return /* @__PURE__ */ jsx42("section", { className: "bg-surface px-4 pb-6 md:px-8 md:pb-8", children: /* @__PURE__ */ jsxs33("div", { className: "relative mx-auto w-full max-w-[1600px] overflow-hidden rounded-3xl", children: [
    /* @__PURE__ */ jsx42("img", { src: backgroundImage, alt: "", "aria-hidden": "true", loading: "lazy", className: "absolute inset-0 size-full object-cover" }),
    /* @__PURE__ */ jsx42("div", { "aria-hidden": "true", className: "absolute inset-0 bg-ink/40" }),
    /* @__PURE__ */ jsxs33("div", { className: "relative px-6 pt-16 sm:px-10 md:px-14 md:pt-24", children: [
      /* @__PURE__ */ jsxs33("div", { className: "grid gap-10 md:grid-cols-2 md:items-start", children: [
        /* @__PURE__ */ jsx42("h2", { className: "max-w-xl font-display text-h2 text-background", children: heading }),
        /* @__PURE__ */ jsxs33("div", { className: "flex flex-col gap-3 sm:flex-row md:justify-end", children: [
          /* @__PURE__ */ jsx42(Button, { asChild: true, variant: "lime", className: "h-12 px-7 text-base hover:scale-100 hover:bg-lime/90", children: /* @__PURE__ */ jsx42("a", { href: primaryCta.href, children: primaryCta.label }) }),
          /* @__PURE__ */ jsx42(
            Button,
            {
              asChild: true,
              ...
              children: /* @__PURE__ */ jsx42("a", { href: secondaryCta.href, target: secondaryCta.external ? "_blank" : void 0, rel: secondaryCta.external ? "noopener noreferrer" : void 0, children: secondaryCta.label })
            }
          )
        ] })
      ] }),
      /* @__PURE__ */ jsxs33("div", { className: "mt-14 rounded-3xl bg-lime p-8 text-lime-foreground md:mt-24 md:p-12", children: [
        /* @__PURE__ */ jsxs33("div", { className: "flex flex-col gap-6 md:flex-row md:items-center md:gap-10", children: [
          /* @__PURE__ */ jsx42(Logo, { src: logoSrc, alt: logoAlt, size: "sm", className: "md:h-8" }),
          /* @__PURE__ */ jsx42("p", { className: "font-display text-2xl leading-tight md:text-3xl", children: promoText })
        ] }),
        /* @__PURE__ */ jsxs33("div", { className: "mt-8 flex flex-col justify-between gap-4 border-t border-lime-foreground/15 pt-6 sm:flex-row sm:items-center", children: [
          /* @__PURE__ */ jsx42("p", { className: "text-sm text-lime-foreground/70", children: copyrightText }),
          /* @__PURE__ */ jsx42(
            "a",
            {
              href: privacyHref,
      ...
      /* @__PURE__ */ jsx42("div", { className: "h-6 md:h-8" })
    ] })
  ] }) });
}
...
function CookieConsentScript(props = {}) {
  return /* @__PURE__ */ jsx43("script", { dangerouslySetInnerHTML: { __html: buildCookieConsentScript(props) } });
}
...
function LandingPageTemplate({ navbar, hero, sections, footer }) {
  return /* @__PURE__ */ jsxs34("div", { className: "flex min-h-screen flex-col", children: [
    /* @__PURE__ */ jsx44(Navbar, { ...navbar }),
    /* @__PURE__ */ jsxs34("main", { className: "flex-1", children: [
      /* @__PURE__ */ jsx44("div", { id: "top" }),
      hero,
      sections
    ] }),
    /* @__PURE__ */ jsx44(Footer, { ...footer })
  ] });
}
