...
function PricingTier({
  ...
  return /* @__PURE__ */ jsxs6(
    "div",
    {
      ...
      children: [
        featured && badgeLabel ? /* @__PURE__ */ jsx15(Badge, { className: "absolute -top-3 left-1/2 -translate-x-1/2 whitespace-nowrap rounded-full bg-primary px-4 py-1.5 text-[11px] font-semibold uppercase tracking-[0.1em] text-primary-foreground", children: badgeLabel }) : null,
        /* @__PURE__ */ jsx15("h3", { className: "font-display text-h5", children: name }),
        /* @__PURE__ */ jsxs6("div", { className: "mt-4 flex items-baseline gap-1", children: [
          /* @__PURE__ */ jsx15("span", { className: "font-display text-h3", children: price }),
          priceSuffix ? /* @__PURE__ */ jsx15("span", { className: "text-muted-foreground", children: priceSuffix }) : null
        ] }),
        priceNote ? /* @__PURE__ */ jsx15("p", { className: "mt-1 text-sm text-muted-foreground", children: priceNote }) : null,
        /* @__PURE__ */ jsx15("p", { className: "mt-4 text-sm text-muted-foreground", children: description }),
        /* @__PURE__ */ jsx15("ul", { className: "mt-6 flex-1 space-y-3", children: features.map((feature) => /* @__PURE__ */ jsxs6("li", { className: "flex items-start gap-2 text-sm", children: [
          /* @__PURE__ */ jsx15(Check, { className: "mt-0.5 h-4 w-4 shrink-0 text-primary" }),
          /* @__PURE__ */ jsx15("span", { children: feature })
        ] }, feature)) }),
        /* @__PURE__ */ jsx15(Button, { type: "button", variant: ctaVariant ?? (featured ? "lime" : "outline"), className: "mt-8 w-full", onClick: onCtaClick, children: ctaLabel })
      ]
    }
  );
}
...
var ConsentCheckboxField = React11.forwardRef(
  ({ consentText, controllerText, moreHref = "#", ...props }, ref) => /* @__PURE__ */ jsxs7("label", { className: "flex gap-3 text-xs text-muted-foreground", children: [
    /* @__PURE__ */ jsx16(Checkbox, { ref, ...props }),
    /* @__PURE__ */ jsxs7("span", { children: [
      consentText,
      /* @__PURE__ */ jsxs7("span", { className: "mt-2 block text-[11px]", children: [
        controllerText,
        " ",
        /* @__PURE__ */ jsx16(Link, { variant: "underline", href: moreHref, children: "More" })
      ] })
    ] })
  ] })
);
...
function StatBlock({ className, eyebrow = "UP TO", value, label, ...props }) {
  return /* @__PURE__ */ jsxs8("div", { className: cn("bg-transparent pr-6", className), ...props, children: [
    /* @__PURE__ */ jsx17("div", { className: "text-[10px] font-semibold uppercase tracking-wider text-muted-foreground", children: eyebrow }),
    /* @__PURE__ */ jsx17("div", { className: "mt-3 font-display text-[56px] leading-none md:text-[72px]", children: value }),
    /* @__PURE__ */ jsx17("div", { className: "mt-6 text-sm text-muted-foreground", children: label })
  ] });
}
...
function IconFeatureItem({
  ...
  return /* @__PURE__ */ jsxs9("li", { className: cn("flex gap-4", className), ...props, children: [
    /* @__PURE__ */ jsx18(Icon, { className: cn("mt-1 h-5 w-5 shrink-0", iconClassName) }),
    /* @__PURE__ */ jsxs9("div", { children: [
      /* @__PURE__ */ jsx18(Heading, { className: "font-display text-h6", children: title }),
      /* @__PURE__ */ jsx18("p", { className: "mt-1 text-sm text-muted-foreground", children: description })
    ] })
  ] });
}
...
function BulletItem({ className, children, ...props }) {
  return /* @__PURE__ */ jsxs10("li", { className: cn("flex gap-3", className), ...props, children: [
    /* @__PURE__ */ jsx19("span", { className: "mt-2 inline-block h-1 w-1 shrink-0 rounded-full bg-muted-foreground" }),
    children
  ] });
}
...
function IconCard({ className, icon: Icon, title, bullets, color, ...props }) {
  return /* @__PURE__ */ jsxs11("div", { className: cn("rounded-3xl bg-card p-8 shadow-sm", className), ...props, children: [
    /* @__PURE__ */ jsxs11("div", { className: "flex items-start justify-between gap-4", children: [
      /* @__PURE__ */ jsx20("h3", { className: "font-display text-h4", children: title }),
      /* @__PURE__ */ jsx20(
        "div",
        {
          className: "grid h-12 w-12 shrink-0 place-items-center rounded-xl",
          style: { background: `linear-gradient(135deg, ${color}, color-mix(in oklab, ${color} 40%, white))` },
          children: /* @__PURE__ */ jsx20(Icon, { className: "h-5 w-5 text-foreground" })
        }
      )
    ] }),
    /* @__PURE__ */ jsx20("ul", { className: "mt-8 space-y-2 text-muted-foreground", children: bullets.map((bullet) => /* @__PURE__ */ jsx20(BulletItem, { children: bullet }, bullet)) })
  ] });
}
...
function StepCard({ className, index, title, body, ...props }) {
  return /* @__PURE__ */ jsxs12("li", { className: cn("p-8", className), ...props, children: [
    /* @__PURE__ */ jsx21(StepNumber, { value: index }),
    /* @__PURE__ */ jsx21("h3", { className: "mt-4 font-display text-h6", children: title }),
    /* @__PURE__ */ jsx21("p", { className: "mt-2 text-sm text-muted-foreground", children: body })
  ] });
}
...
function IndustryCard({
  ...
  const imageBlock = /* @__PURE__ */ jsx22(
    "div",
    {
      className: cn(
        "bg-cover bg-center",
  ...
  const content = /* @__PURE__ */ jsxs13("div", { className: cn(layout === "stacked" ? "flex flex-col justify-between p-10 md:p-12" : "p-8"), children: [
    /* @__PURE__ */ jsx22(
      "h3",
      {
    ...
    /* @__PURE__ */ jsxs13("div", { className: layout === "grid" ? "mt-4" : void 0, children: [
      /* @__PURE__ */ jsx22("p", { className: cn("max-w-md text-sm leading-relaxed text-foreground/75", layout === "stacked" && "mt-8"), children: description }),
      /* @__PURE__ */ jsx22(
        Button,
        {
          type: "button",
  ...
  return /* @__PURE__ */ jsx22(
    "article",
    {
      ...
      ...props,
      children: layout === "stacked" ? /* @__PURE__ */ jsxs13(Fragment, { children: [
        content,
        imageBlock
...
function OverlapCard({
  ...
  return /* @__PURE__ */ jsxs14(
    "article",
    {
      ...
      ...props,
      children: [
        /* @__PURE__ */ jsxs14("div", { className: "flex flex-col justify-between p-10 md:p-12", children: [
          /* @__PURE__ */ jsx23("h3", { className: "font-display text-h3 whitespace-pre-line", children: title }),
          /* @__PURE__ */ jsxs14("div", { className: "mt-8", children: [
            /* @__PURE__ */ jsx23("p", { className: "max-w-md text-sm leading-relaxed text-foreground/75", children: description }),
            /* @__PURE__ */ jsxs14("div", { className: "mt-8 flex flex-wrap gap-3", children: [
              /* @__PURE__ */ jsx23(Button, { type: "button", variant: "solid", size: "xs", onClick: primaryCta.onClick, children: primaryCta.label }),
              /* @__PURE__ */ jsx23(
                Button,
                {
                  type: "button",
...
function FaqItem({ value, question, answer }) {
  return /* @__PURE__ */ jsxs15(AccordionItem, { value, className: "rounded-2xl border-0 bg-card px-6 py-1 md:px-8", children: [
    /* @__PURE__ */ jsx24(AccordionTrigger, { className: "py-6 text-left text-lg font-semibold hover:no-underline md:text-xl [&>svg]:size-5", children: question }),
    /* @__PURE__ */ jsx24(AccordionContent, { className: "pb-8 pt-2 text-base text-muted-foreground md:text-[17px]", children: answer })
  ] });
}
...
function PartnerCountBadge({ className, count, label, ...props }) {
  return /* @__PURE__ */ jsxs16(
    "div",
    {
      ...
      ...props,
      children: [
        /* @__PURE__ */ jsx25("span", { className: "text-sm font-semibold text-foreground", children: count }),
        /* @__PURE__ */ jsx25("span", { className: "text-xs", children: label })
      ]
    }
  );
}
...
function buildCookieConsentScript({
  ...
  if (cmpCdid === AUTOPAYLAB_CMP_CDID && !warnedAboutDefaultCdid) {
    ...
    console.warn(
      `[landing-design-system] CookieConsentScript is using autopaylab.com's default ConsentManager cmp_cdid (${AUTOPAYLAB_CMP_CDID}). If this page lives on a different domain or consent scope, it needs its own cdid from its own ConsentManager account -- pass cmpCdid explicitly once you've confirmed the right value. If this really is an autopaylab.com page, this warning is expected and safe to ignore.`
    );
  }
  return `
(function () {
